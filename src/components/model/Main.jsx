...
export const Main = ({setOpen}) => {
  ...
  return (
    <section className='fixed w-full h-screen  left-0 top-0 flex items-center justify-center'>
      <CheckOutsideClick onClickOutside={handleClose}>
      <div className=' w-[24rem] h-[20rem] bg-gray-50 bg-opacity-50 backdrop-filter backdrop-blur-sm px-4 py-2 rounded-md'>
        <form action="">
